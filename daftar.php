...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-12 col-lg-4 mx-auto">
			<center>
				<a href="index.php"><img src="gambar/sistem/hUtama.jpg" style="width:auto; height: 150px;"></a>
			</center>
			<br>
			<center><h5>Daftar Akun</h5></center>
			...
			<div class="">
				...
				<form action="daftar_aksi.php" method="post">
					...
					<input type="submit" class="btn btn-success btn-block mt-4" value="DAFTAR">
					<p class="text-center mt-3">
						Sudah punya akun? 
						<br>
						<div class="text-center"><a href="index.php">Login</a></div>
					</p>
